...
\begin{itemize}
	...
	PDB2PQR provides an empirical model (PROPKA \cite{Sondergaard2011}) that uses a heuristic method to compute p$K_a$ perturbations due to desolvation, hydrogen bonding, and charge-charge interactions and is included in PDB2PQR.
...
We have also worked with the developers of Jmol \cite{Jmolweb, Herraez2006} and 3Dmol.js \cite{3Dmolweb, Rego2015} to provide web-based setup and visualization of APBS-PDBD2PQR calculations and related workflows.
